...
void main() {
  group('GherkinExpression', () {
    test('parse simple regex expression correctly', () async {
      ...
      expect(await parser.getParameters('I close the drawer'), equals(['close']));
    });
    ...
    test('parse simple non-capturing group expression correctly', () async {
      ...
      expect(await parser.getParameters('I have 2 apples in my belly'), equals([2]));
      expect(await parser.getParameters('I have 42 pears in my belly'), equals([42]));
    });
