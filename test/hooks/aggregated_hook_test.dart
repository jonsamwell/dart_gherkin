...
void main() {
  group('orders hooks', () {
    test('executes hooks in correct order', () async {
      ...
      await aggregatedHook.onBeforeRun(TestConfiguration());
      ...
      await aggregatedHook.onAfterRun(TestConfiguration());
      ...
      await aggregatedHook.onBeforeScenario(TestConfiguration(), '', []);
      ...
      await aggregatedHook.onAfterScenarioWorldCreated(World(), '', []);
